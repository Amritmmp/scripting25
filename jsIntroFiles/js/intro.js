...
console.log("Hello World! This is some words from Amrit.");
...
document.getElementById("column1").innerHTML = "<h3>Wow!</h3> <p>This is amazing!!! Look at me go!!!<p>";
//+= means to add it to what is already there
...
//try to change column2 background color
...
// else if weapon equals Squids
// then give a different message
//otherwwise (else)
// then give a different message
//if(condition){ is the statement if that is true}else if(){}else{}
if(weapon=="Fists") {
    document.getElementById("column3").innerHTML += "<p>You are using the power of FISTS";
}else if(weapons == "Squids") {
    document.getElementById("column3").innerHTML += "<p>SQUID Power is Rad</p>"
}else{
    document.getElementById("column3").innerHTML += "<p> Your weapon doesn't work here!</p>"
}
